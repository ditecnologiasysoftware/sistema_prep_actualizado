...
if ($_SERVER['REQUEST_METHOD'] == 'OPTIONS') {
	...
	$idrepresenta = $funciones->limpia($_GET['idrepresenta']);
	$foto_acta = $funciones->limpia($_GET['foto_acta']);

	$idCandidato = $conexion->consultadato("SELECT id_candidato FROM tblc_candidato WHERE id_proceso_electoral =".$idprocesoEleccion);

    $consulta = "INSERT INTO tbl_acta(id_candidato, id_casilla, archivo, id_representante, fecha_registro) VALUES(".$idCandidato.", ".$idcasi.", '".$foto_acta."' , '".$idrepresenta."', NOW())";
