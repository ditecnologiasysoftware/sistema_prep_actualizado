                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div id="etiquetas" class="cloud-label-widget-content">
                                             <?php
                                             $total = $conexion->consultadato("SELECT (SELECT COUNT(re.id_reporte) FROM tbl_reporte_etiqueta AS re INNER JOIN tbl_reporte AS r ON re.id_reporte = r.id_reporte WHERE re.id_etiqueta = e.id_etiqueta".$sentencias2.") AS conteo FROM tblc_etiqueta AS e ORDER BY conteo DESC LIMIT 1 ");
                                             $etiquetas = $conexion->obtenerlista("SELECT e.etiqueta, e.id_etiqueta, (SELECT COUNT(re.id_reporte) FROM tbl_reporte_etiqueta AS re INNER JOIN tbl_reporte AS r ON re.id_reporte = r.id_reporte WHERE e.id_etiqueta = re.id_etiqueta".$sentencias2.") AS conteo FROM tblc_etiqueta AS e ORDER BY conteo");
    ...
    var data = new google.visualization.DataTable();
        ...
        data.addRows([
    <?php
            $real = $conexion->consultadato("SELECT COUNT(id_reporte) FROM tbl_reporte WHERE tipo_registro = 1".$sentencias);
            $fuera = $conexion->consultadato("SELECT COUNT(id_reporte) FROM tbl_reporte WHERE tipo_registro = 2".$sentencias);
    ...
    var data = new google.visualization.DataTable();
        ...
        data.addRows([
    <?php
    $categorias = $conexion->obtenerlista("SELECT c.nombre, (SELECT COUNT(re.id_reporte) FROM tbl_reporte_etiqueta AS re INNER JOIN tbl_reporte AS r ON re.id_reporte = r.id_reporte INNER JOIN tblc_etiqueta AS e ON e.id_etiqueta = re.id_etiqueta WHERE e.id_categoria = c.id_categoria".$sentencias2.") AS conteo FROM tblc_categoria AS c ORDER BY conteo DESC");
    $cadena = "";
      ...
      var options = {
        ...
        var data = google.visualization.arrayToDataTable([
          ...
          foreach ($meses as $clave => $valor) {
            ...
            $denuncias2 = $conexion->consultadato("SELECT COUNT(id_reporte) FROM tbl_reporte WHERE tipo_reporte = 1 AND MONTH(fecha_registro) = '".$clave."' AND YEAR(fecha_registro) = '".$anio."'".$sentencias); 
            $observaciones2 = $conexion->consultadato("SELECT COUNT(id_reporte) FROM tbl_reporte WHERE tipo_reporte = 2 AND MONTH(fecha_registro) = '".$clave."' AND YEAR(fecha_registro) = '".$anio."'".$sentencias); 
            if($clave == '07'){
