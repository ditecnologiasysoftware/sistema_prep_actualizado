                        ...
                        <td width="100%">
                            <div class="form-group">
                                ...
                                <form id="form_busqueda">
                                    ...
                                    <input type="button" class="btn btn-primary mr5" value="Buscar" onclick="municipios_lista()" />
                                    <input type="button" class="btn btn-secundary mr5" onclick="window.location.href='municipios'" value="Cancelar">
