    ...
    <div class="media">
        ...
        <div class="media-body">
            <ul class="breadcrumb">
                ...
                <li>Catálogo de etiquetas</li>
            </ul>
            <h4>Catálogo de etiquetas</h4>
        </div>
    </div>
</div>
                        ...
                        <td width="100%">
                            <div class="form-group">
                                ...
                                <form id="form_busqueda">
                                    ...
                                    <input type="button" class="btn btn-secundary mr5" onclick="window.location.href='etiquetas'" value="Cancelar">
